...
* Edit the local.conf file with below content in the controller node. My host IP is "192.168.130.102" and I wish to install everything with password "mypassword123". You may choose a different password for your setup.
